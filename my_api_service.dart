...
const String photoUrl =
    "https://easysuperapps.com//easysuperapps.com/api/post_photo.php/post_photo.php";
...
class MyApiService {
  ...
  static void updateOrder(int uid, int oid, String action) async {
    const String unencodedPath =
        "/easysuperapps.com/api/update_order.php/update_order.php";
    ...
    await http.post(Uri.http(url, unencodedPath), body: body);
  }
  ...
  static Future<List> getOrdersId(int uid, String status) async {
    String unencodedPath =
        "/easysuperapps.com/api/driver_orders.php/driver_orders.php";
  ...
  static Future<Map<String, dynamic>> getOrder(int oid) async {
    const String unencodedPath =
        "/easysuperapps.com/api/driver_order.php/driver_order.php";
  ...
  static void photoRegister(String username, String icPath, String licensePath,
      String frontVehiclePath, String backVehiclePath) async {
    Map<String, dynamic> map = {};
    map["username"] = username;
    map["ic"] = await MultipartFile.fromFile(icPath,
        filename: "ic.jpeg", contentType: MediaType("image", "jpeg"));
    map["license"] = await MultipartFile.fromFile(licensePath,
        filename: "license.jpeg", contentType: MediaType("image", "jpeg"));
    map["front"] = await MultipartFile.fromFile(frontVehiclePath,
        filename: "front.jpeg", contentType: MediaType("image", "jpeg"));
    map["back"] = await MultipartFile.fromFile(backVehiclePath,
        filename: "back.jpeg", contentType: MediaType("image", "jpeg"));
  ...
  static void photoPOD(int oid, String filePath) async {
    Map<String, dynamic> map = {};
    map["pod"] = await MultipartFile.fromFile(filePath,
        filename: "pod_image.jpeg", contentType: MediaType("image", "jpeg"));
    map["oid"] = "$oid";
    FormData formData = FormData.fromMap(map);
  ...
  static void photoPOC(int oid, String filePath) async {
    Map<String, dynamic> map = {};
    map["poc"] = await MultipartFile.fromFile(filePath,
        filename: "pod_image.jpeg", contentType: MediaType("image", "jpeg"));
    map["oid"] = "$oid";
    FormData formData = FormData.fromMap(map);
    final response = await Dio().post(photoUrl, data: formData);
  ...
  static Future<List> getRegions() async {
    ...
    const String unencodedPath =
        "/easysuperapps.com/api/regions.php/regions.php";
  ...
  static Future<List> getVehicles() async {
    ...
    const String url =
        "https://easysuperapps.com//easysuperapps.com/api/vehicle_types.php/vehicle_types.php";
  ...
  static Future<Map<String, dynamic>> getMeritStatement(String userId) async {
    const String unencodedPath =
        "/easysuperapps.com/api/merit_statement.php/merit_statement.php";
  ...
  static Future<Map<String, dynamic>> getCommissionStatement(
      String userId) async {
    const String unencodedPath =
        "/easysuperapps.com/api/commission_statement.php/commission_statement.php";
    final Map<String, String> body = {'uid': userId};
    final response = await http.post(Uri.http(url, unencodedPath), body: body);
  ...
  static Future<void> updateDriverOnOff(int driverId, String onOff) async {
    const String unencodedPath =
        "/easysuperapps.com/api/driver_on_off.php/driver_on_off.php";
    final Map<String, String> body = {'uid': "$driverId", 'onoff': onOff};
    await http.post(Uri.http(url, unencodedPath), body: body);
  }

  static Future<List<NotificationData>> fetchNoti(
      int driverId, String year, String month) async {
    const String unencodedPath =
        "/easysuperapps.com/api/notification_statement.php/notification_statement.php";
    final Map<String, String> body =
        ({'uid': "$driverId", 'year': year, 'month': month});
    final response = await http.post(Uri.http(url, unencodedPath), body: body);
  ...
  static Future<bool> driverApply(Map<String, String> body) async {
    const String unencodedPath =
        "/easysuperapps.com/api/driver_apply.php/driver_apply.php";
    final response = await http.post(Uri.http(url, unencodedPath), body: body);
  ...
  static Future<Map<String, dynamic>> driverLogIn(
    ...
    const String unencodedPath =
        "/easysuperapps.com/api/driver_login.php/driver_login.php";
    final response = await http.post(Uri.http(url, unencodedPath), body: body);
  ...
  static Future<Map<String, dynamic>> getDriverId(String username) async {
    ...
    const String unencodedPath =
        "/easysuperapps.com/api/driver_id.php/driver_id.php";
    final response = await http.post(Uri.http(url, unencodedPath), body: body);
  ...
  static Future<void> updateToken(int driverId, String token) async {
    const String unencodedPath =
        "/easysuperapps.com/api/insert_token.php/insert_token.php";
  ...
  static void updateLocation(String position, int driverId) async {
    const String unencodedPath =
        "/easysuperapps.com/api/location.php/location.php";
    final Map<String, String> body = {"uid": "$driverId", "location": position};
  ...
  static Future<bool> convertMerit(int driverId) async {
    const String unencodedPath =
        "/easysuperapps.com/api/convert_merit.php/convert_merit.php";
    final Map<String, String> body = {
      'uid': "$driverId",
    };
  ...
  static Future<String> requestWithdraw(Map<String, String> body) async {
    const String unencodedPath =
        "/easysuperapps.com/api/request_withdraw.php/request_withdraw.php";
    final response = await http.post(Uri.http(url, unencodedPath), body: body);
    final data = json.decode(response.body);
    return (data["message"]);
  }
